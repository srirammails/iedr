...
class GridModelBase
    ...
    /**
     * @var array array of fields excluded from csv,excel export
     */
    public $excludeFromExport = array();
	...
	public function getSearch($searchparams)
		...
		foreach($searchparams as $k => $r)
			{
			Yii::log('searchparam : (k)'.print_r($k,true).' => (r)'.print_r($r,true), 'debug', 'GridModelBase::getSearch()');
