...
switch ($model->command)
{
    ...
    case 'reactivate':
        ...
        break;
     case 'voluntary':
        $cmdString = 'Put into Volountary NRP';
        break;    
}

$isVoluntary = ($model->command == 'voluntary') ? true : false;
$isAutoRenew = ($model->command == 'autorenew') ? true : false;
