...
$this->open("/index.php");
    ...
    for ($second = 0; ; $second++) {
        ...
        try {
            if ("View 1 - 15 of 27" == $this->getTable("css=table.ui-pg-table.0.2")) break;
        } catch (Exception $e) {}
        sleep(1);
    }

    $this->assertEquals("View 1 - 15 of 27", $this->getText("css=div.ui-paging-info"));
...
for ($second = 0; ; $second++) {
        if ($second >= 60) $this->fail("timeout");
        try {
            if ("View 16 - 27 of 27" == $this->getTable("css=table.ui-pg-table.0.2")) break;
        } catch (Exception $e) {}
        sleep(1);
    }
