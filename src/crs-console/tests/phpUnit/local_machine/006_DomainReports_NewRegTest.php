...
for ($second = 0; ; $second++) {
        ...
        try {
            if ($this->isTextPresent("View 1 - 15 of 220")) break;
        } catch (Exception $e) {}
        sleep(1);
}
    $this->assertEquals("View 1 - 15 of 220", $this->getText("css=div.ui-paging-info"));
