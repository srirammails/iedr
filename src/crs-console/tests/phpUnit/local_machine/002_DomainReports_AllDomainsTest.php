...
class DomainReportsAll extends PHPUnit_Extensions_SeleniumTestCase
{
...
for ($second = 0; ; $second++) {
        ...
        try {
            if ($this->isTextPresent("View 1 - 15 of 1,001")) break;
        } catch (Exception $e) {}
        sleep(1);
}
...
$dom_arr = getDomainStatus("example0100.ie");


$domain1=$dom_arr["domain"];
$regDate=$dom_arr["regDate"];
$renewDate=$dom_arr["renDate"];
$status=$dom_arr["status"];
