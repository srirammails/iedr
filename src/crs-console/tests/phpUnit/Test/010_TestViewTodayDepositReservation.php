...
class TestViewTodayDepositReservation extends SetupPhpUnit {
	 
	public static function setUpBeforeClass() {
		TestUtility::query("INSERT INTO Reservation VALUES(9,'IDL2-IEDR','newregisterd1.ie',12,'2012-10-17 08:17:51','65.00',3,'13.91','Y','N',NULL,NULL,55,'Std1Year','transfer',NULL,NULL,'Deposit')");
		TestUtility::query("INSERT INTO Reservation VALUES(10,'IDL2-IEDR','newregisterd2.ie',12,'2012-10-17 08:17:51','65.00',3,'13.91','Y','N',NULL,NULL,55,'Std1Year','renewal',NULL,NULL,'Deposit')");
		TestUtility::query("INSERT INTO Reservation VALUES(11,'IDL2-IEDR','newregisterd3.ie',12,'2012-10-17 08:17:51','65.00',3,'13.91','Y','N',NULL,NULL,55,'Std1Year','registration',NULL,NULL,'Deposit')");
	}
	...
	public function testViewCCTodayReservation() {
		$this->login();
		$this->click("link=View Today`s Deposit Reservations");
