<?php include('test_config.php'); test_header('Transfer Invoice - put in MSD'); ?>
<tr><td>setTimeout</td><td><?php echo $timeout; ?></td><td></td></tr>
<tr><td>setSpeed</td><td><?php echo $speed; ?></td><td></td></tr>
<tr><td>open</td><td><?php echo $base; ?>/index.php?r=accounts_renewpay_advpay/transfers_pia</td><td></td></tr>
<tr><td>waitForTextPresent</td><td>IE Domain Registry Ltd</td><td></td></tr>
<?php
$domain1='example0114.ie';
$arr[dom1]='example0114.ie';
$arr[dom2]='example0118.ie';
$arr[dom3]='example0792.ie';
$arr[dom4]='example0847.ie';
$period='1';
$type='0';
$price = getPrice($period, $type);
$vatrate = getVatRate($account_number);
$total = $price+($price*$vatrate);
//The purpose of this test is to put domain names into MSD from the trasnfer invoice. Then check the domain names in Domain View and ensure that their billing status has been updated accordingly
                // PUT DOMAINS IN MSD
?>

<tr><td>pause</td><td>2500</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0114.ie</td><td></td></tr>
<tr><td>click</td><td>//td[@id='next']/span</td><td></td></tr>
<tr><td>pause</td><td>2500</td><td></td></tr>
<tr><td>waitForText</td><td>jqg_thisJqGrid_example0118.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0118.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0792.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0847.ie</td><td></td></tr>
