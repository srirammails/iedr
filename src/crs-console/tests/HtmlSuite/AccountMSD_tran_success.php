...
<?php
$domain1='example0136.ie';
$arr[dom1]='example0136.ie';
$arr[dom3]='example0217.ie';
$arr[dom4]='example0219.ie';
$arr[dom4]='example0315.ie';
$period='1';
$type='0';
$price = getPrice($period, $type);
$vatrate = getVatRate($account_number);
$total = $price+($price*$vatrate);
//The purpose of this test is to put domain names into MSD from the current transfer grid. Then check the domain names in Domain View and ensure that their billing status has been updated accordingly
                // PUT DOMAINS IN MSD
?>


<tr><td>pause</td><td>2500</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0136.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0217.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0219.ie</td><td></td></tr>
<tr><td>click</td><td>jqg_thisJqGrid_example0315.ie</td><td></td></tr>
