...
{
//This test script is paying for a domain name from deposit account from the current invoice and also ensuring that the correct amount has been charged
                // set value, reload, check output

?>

<!-- select domain name from grid and click on Pay by Deposit option --> 
