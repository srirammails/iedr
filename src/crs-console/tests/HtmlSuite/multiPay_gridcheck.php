...
$Nprice =number_format(($price*$arr_count),2);
$Nvat = number_format(($arr_count*$vat),2);
$Ntotal = number_format(($arr_count*$total),2);
...
<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[2]/td[5]</td><td>€ <?php echo $Nprice; ?></td></tr>
<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[2]/td[6]</td><td>€ <?php echo $Nvat; ?></td></tr>
<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[2]/td[7]</td><td>€ <?php echo $Ntotal; ?></td></tr>

<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[3]/td[3]</td><td>€ <?php echo $Nprice; ?></td></tr>
<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[3]/td[4]</td><td>€ <?php echo $Nvat; ?></td></tr>
<tr><td>assertText</td><td>//div[@id='content']/div/table/tbody/tr[3]/td[5]</td><td>€ <?php echo $Ntotal; ?></td></tr>
...
$b_status= getBillStatus($name);
$d_status= getDomainStatus($name);
$renDate = getRenDate($name, $period);
?>
