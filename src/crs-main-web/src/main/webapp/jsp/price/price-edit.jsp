...
<n:group2 titleText="Product Price" cssIcon="group-icon-document">
    <s:form theme="simple">
        <center>
            <n:field label="Id" cssContainer="force-margin-left30 force-width30">
                <s:textfield name="wrapper.id" disabled="true"/>
            </n:field>
        ...
        <center>
            ...
            <s:submit value="Save" theme="simple" action="priceEdit-save"/>
        </center>
    </s:form>
</n:group2>
</body>
