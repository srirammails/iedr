...
<s:set var="eventNameList" value="EventNames"/>
...
<n:group2 titleText="Force DSM Event" cssIcon="group-icon-document">
    <s:form theme="simple">
        <center>
            ...
            <n:field label="Events" hideTooltipGap="true"
                     cssContainer="force-margin-left30 force-width30">
                <s:select list="eventNameList" name="wrapper.eventName"
        ...
        <center>
            ...
            <s:submit value="Force" theme="simple" action="forceDSMevent-force"/>
        </center>
    </s:form>
</n:group2>
</body>
