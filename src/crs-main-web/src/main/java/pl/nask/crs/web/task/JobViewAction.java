 ...
 */
public class JobViewAction extends GenericSearchAction<Job, JobSearchCriteria> {

    private SchedulerCron scheduler;
	
    public JobViewAction(SchedulerCron scheduler) {
		this.scheduler = scheduler;
    }
    
    protected TicketsPaginatedList<Job> performSearch(JobSearchCriteria criteria, TableParams tableParams, int pageSize) throws Exception {
         ...
         LimitedSearchResult<Job> searchResult = scheduler.findJobs(getUser(), criteria, ((long) (tableParams.getPage() - 1))
